...
public class CustomApiError {
	...
	protected CustomApiError(HttpStatus status, Throwable ex) {
		this();
		this.status = status;
	...
	protected CustomApiError(HttpStatus status, String message, Throwable ex) {
		this();
		this.status = status;
	...
	protected CustomApiError(HttpStatus status, String message, String debugMessage, List<ApiSubError> subErrors) {
		this();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		CustomApiError other = (CustomApiError) obj;
	...
	class ApiValidationError extends ApiSubError {
		...
		private CustomApiError getOuterType() {
			return CustomApiError.this;
		}
